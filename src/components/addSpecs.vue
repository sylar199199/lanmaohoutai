                        ...
                        <tr v-for="(item,index) in tableData" :key="item.id">
                            <td>
                                <div class="flex">
                                    ...
                                    <i class='iconfont iconxuanze1 color2087' @click="selectAdver(item)" v-if='!item.isSelect &&(!item.hasSelect)' ></i>
                                    <el-checkbox label="" v-if='item.isSelect &&(item.hasSelect)' class='selectIcon'  disabled v-model="checked2"></el-checkbox>
    ...
    export default {
        ...
        data() {
            return {
                ...
                checkList: [],
                selectNumber: 0,
                sortDatas: [{orderType:'',name: '商品',showBlue: true,orderField: ''},{orderType:'',name: '消耗积分',showBlue: false,orderField: ''},{orderType:'',name: '已兑换',showBlue: false,orderField: ''},{orderType:'asc',name: '剩余库存',showBlue: false,orderField:''},{orderType:'desc',name:'创建时间',showBlue: false,orderField: ''}],
                name: '',
