...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            addCommodity(){
                this.$router.push({name:'addlimitactive'})
            },
            goDetail(id){
                this.$router.push({name:'addlimitactive',query:{id:id}})
            },
                    ...
                    if(response.errorCode == 0){
                        if(response.data.records.length == 0){
                            ...
                            for(var i = 0;i< response.data.records.length;i++){
                                ...
                                console.log( response.data.records[i].startTime,Date.parse(new Date()))
                                console.log( response.data.records[i].startTime<Date.parse(new Date()))
                                console.log( response.data.records[i].endTime>Date.parse(new Date()))
