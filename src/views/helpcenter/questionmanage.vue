                ...
                <div class="contanternews">
                    <div class="selectChannel backWhite padding20 baseInfo">
                        <div class="channnelTitle font16 colorblack" >问答管理
                            <i  @mouseover="showImg = true" @mouseout="showImg = false"  class="iconfont iconwenhao cursor  color2087 font18"></i>
                            <img class="detailImg" v-if="showImg" src="../../assets/images/helpcenterImg.png">
                        </div>
                        <div class="categoryBox flex ">
                            <div @click="changeItem(item)" :class="item.isSelect?'categoryName cursor selectcategoryName':'categoryName cursor'" class="categoryName font12" v-for="(item,index) in categoryList">
                                <span :class="item.isSelect?'colorfff':'color2087'">{{item.name}}</span>
                                <i @click="editorcategory(item.id)" :class="item.isSelect?'iconfont iconbianji colorfff':'color2087 iconfont iconbianji'"></i>
                            </div>
                            <i class="iconfont iconadd marginLeft10 color2087 font18 cursor" @click="editorcategory()" ></i>
                        ...
                        <div class="commonProblem" >
                            <div class="problemBox" v-for="(item,index) in faqs">
                                ...
                                <i class="iconfont iconcuowu font16 colorGrey cursor"  @click="deleteItem(item.id)"></i>
            ...
            <div class="messge">
                ...
                <div class="messageContent">
                    <div class="messagemessage">
                        ...
                        <input type="text" v-model="category.name" @change="changeValue('name','')" class="inputBox marginLeft10 colorblack font12" placeholder="请输入分类名称"/>
                    </div>
                    <div class="messagemessage">
                    ...
                    <div class="messagemessage flex">
                        <div @dragstart="handleDragStart($event,item)"
                            ...
                            {{item.name}}
                            <i class="iconfont iconcuowu cursor" @click="deleteCategory(item.id)"></i>
                        </div>
                    </div>
