                ...
                <div class="contanternews">
                    <div class="dataGeneral backWhite padding20">
                        <div class="flexCenter flex">
                            ...
                            <span class="font12 colorGrey" style="margin-left:10px;">图片格式要求（750*775），大小不超过2M</span>
                        </div>
                        ...
                        <table  v-if="noData" class="table">
                            ...
                            <tr v-for="item in tableData" :key="item.id">
                               <td>
                                ...
                                <td>
                                    <span class="color2087 font12  fontWeight" v-if="item.enabled" >当前引导页</span>
                                    <span class="color2087 font12  fontWeight"  v-if="!item.enabled" @click="sureenabled(item.id)">设置为引导页</span>
                                      <span class="line" v-if="!item.enabled" ></span>
                                    <span v-if="!item.enabled" class="color2087 font12  fontWeight" @click="deletebackground(item.id)">删除</span>
                                </td>
                            </tr>
                        </table>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            sureenabled(id){
                this.$confirm( '设置此引导页会替换当前引导页，确定设置?', '', {
                    confirmButtonText: '确定',
                    cancelButtonText: '取消',
                    type: 'warning'
                }).then(() => {
                    Service.guide().enableguidepost({
                    },id).then(response => {
